 ...
 */
export const fetchMetadata = https.onCall(async (req) => {
    const url = req.data?.url;
    if (!url)
        throw new https.HttpsError('invalid-argument', 'url requerida');
    try {
 ...
 */
export const enrichBookmark = firestore.onDocumentCreated('users/{uid}/bookmarks/{bookmarkId}', async (event) => {
